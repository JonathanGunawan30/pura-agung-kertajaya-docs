...
Informasi yang akurat di sini sangat vital untuk memudahkan umat atau tamu menemukan lokasi Pura.
...
![Tampilan Halaman Kontak di Website](/img/pura/contact-public.png)
...
![Tampilan Informasi Kontak di Admin](/img/pura/contact-list.png)
...
![Formulir Edit Kontak](/img/pura/contact-form.png)
...
Kolom ini berisi *link khusus* agar peta bisa muncul. **JANGAN DIUBAH** jika lokasi pura tidak pindah.
