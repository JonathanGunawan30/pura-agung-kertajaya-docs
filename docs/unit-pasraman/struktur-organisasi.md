...
Menu ini digunakan untuk menampilkan susunan pengurus Pasraman Nonformal Kertajaya.
...
![Tampilan Struktur Organisasi di Website](/img/pasraman/organization-public.png)
...
![Formulir Upload Gambar Struktur](/img/pasraman/organization-image-form.png)

1.  Masuk ke menu **Struktur Organisasi**.
2.  Di bagian bawah, Anda akan melihat area pratinjau gambar bagan.
3.  Klik tombol **Ganti Gambar** (berwarna biru) di pojok kanan bawah area gambar.
...
![Daftar Anggota Organisasi](/img/pasraman/organization-list.png)
...
![Formulir Tambah Anggota](/img/pasraman/organization-form.png)
...
![Menu Edit Hapus Organisasi](/img/pasraman/organization-popup.png)
